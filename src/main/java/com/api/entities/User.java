...
public class User {
	...
	public String toString() {
		return "User [id=" + id + ", name=" + name + ", age=" + age + ", email=" + email + ", password=" + password
				+ ", imageName=" + imageName + ", dateOfBirth=" + dateOfBirth + ", timeOfBirth=" + timeOfBirth
				+ ", contactNumber=" + contactNumber + ", place=" + place + ", gender=" + gender + ", walletBalance="
				+ walletBalance + ", astrlogerId=" + astrlogerId + "]";
	}
	...
	public User(int id,
			...
			@NotNull(message = "Field Gender is required") Gender gender, double walletBalance, int astrlogerId) {
		super();
		this.id = id;
		this.name = name;
		this.age = age;
